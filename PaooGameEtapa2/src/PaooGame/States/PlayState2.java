...
public class PlayState2 extends PlayState
{
    ...
    private static PlayState2 playState = null;
     ...
     */
    private PlayState2(RefLinks refLink)
    {
    ...
    public static synchronized PlayState2 getInstance(RefLinks refLink)
    {
        if(playState == null)
        {
            playState = new PlayState2(refLink);
        }
        return playState;
    }
