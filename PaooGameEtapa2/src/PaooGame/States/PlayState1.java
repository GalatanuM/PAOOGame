...
public class PlayState1 extends PlayState
{
    ...
    private static PlayState1 playState = null;
     ...
     */
    private PlayState1(RefLinks refLink)
    {
    ...
    public static synchronized PlayState1 getInstance(RefLinks refLink)
    {
        if(playState == null)
        {
            playState = new PlayState1(refLink);
        }
        return playState;
    }
